...
public class JdbcTransferDao implements TransferDao {
    ...
    public List<TransferDto> findAll() {
        ...
        while(result.next()) {
            transferDtoList.add(mapRowToUser(result));
        }
    ...
    public TransferDto findByTransferId(int id) {
        ...
        if(result.next()){
            transferDto = mapRowToUser(result);
        }
        return transferDto;
    }
    ...
    @Override
    public List<TransferDto> findByUsername(String username) {
        List<TransferDto> transferDtoList = new ArrayList<>();
    ...
    private TransferDto mapRowToUser(SqlRowSet rs) {
